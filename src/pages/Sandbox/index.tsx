...
import { SimulationResponse, AsyncState, AutomationResult } from '../../types';
                      ...
                      <div className="flex-1 space-y-4">
                        <div className="flex items-center justify-between">
                          ...
                          <span className={`text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded-full border ${
                            step.status === 'success' ? 'bg-emerald-50 text-emerald-600 border-emerald-100' : 'bg-red-600 text-red-600 border-red-100'
                          }`}>
                            {step.status}
                          </span>
                        </div>
